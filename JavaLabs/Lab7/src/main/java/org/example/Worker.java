...
class Worker extends Bee {
    ...
    public void setInterestPointX(int interestPointX) {
        this.interestPointX = interestPointX;
    }

    public void setInterestPointY(int interestPointY) {
    ...
    public String toString() {
        return "Worker [interestPointX=" + interestPointX + ", interestPointY=" + interestPointY + ", bornX=" + bornX
                + ", bornY=" + bornY + ", isReached=" + isReached + ", bornTime=" + bornTime + "]";
    }
